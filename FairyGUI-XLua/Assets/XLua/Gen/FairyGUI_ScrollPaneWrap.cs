...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIScrollPaneWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 20, 34, 18);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "UpdateScrollBarVisible", _m_UpdateScrollBarVisible);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "isDragged", _g_get_isDragged);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_UpdateScrollBarVisible(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.UpdateScrollBarVisible(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_isDragged(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                FairyGUI.ScrollPane gen_to_be_invoked = (FairyGUI.ScrollPane)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.isDragged);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
