    ...
    public class FairyGUIGGraphWrap 
    {
        ...
        static int _m_DrawPolygon(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<UnityEngine.Vector2[]>(L, 4)&& translator.Assignable<UnityEngine.Color>(L, 5)) 
                {
                    float _aWidth = (float)LuaAPI.lua_tonumber(L, 2);
                    float _aHeight = (float)LuaAPI.lua_tonumber(L, 3);
                ...
                if(gen_param_count == 7&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<UnityEngine.Vector2[]>(L, 4)&& translator.Assignable<UnityEngine.Color>(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)&& translator.Assignable<UnityEngine.Color>(L, 7)) 
                {
                    float _aWidth = (float)LuaAPI.lua_tonumber(L, 2);
                    float _aHeight = (float)LuaAPI.lua_tonumber(L, 3);
                    UnityEngine.Vector2[] _points = (UnityEngine.Vector2[])translator.GetObject(L, 4, typeof(UnityEngine.Vector2[]));
