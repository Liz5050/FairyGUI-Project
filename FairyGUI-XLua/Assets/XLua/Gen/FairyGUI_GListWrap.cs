...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGListWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 28, 22, 17);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetNumItems", _m_SetNumItems);
        ...
        static int _m_GetSelection(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<System.Collections.Generic.List<int>>(L, 2)) 
                {
                    System.Collections.Generic.List<int> _result = (System.Collections.Generic.List<int>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<int>));
                        ...
                        System.Collections.Generic.List<int> gen_ret = gen_to_be_invoked.GetSelection( _result );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.GList.GetSelection!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetNumItems(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetNumItems( _num );
