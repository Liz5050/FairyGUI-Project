...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUIPackageWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "GetVar", _m_GetVar_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "SetVar", _m_SetVar_xlua_st_);
			...
			Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "branch", _g_get_branch);
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "unloadBundleByFGUI", _g_get_unloadBundleByFGUI);
            
			Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "branch", _s_set_branch);
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "unloadBundleByFGUI", _s_set_unloadBundleByFGUI);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetVar_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _key = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = FairyGUI.UIPackage.GetVar( _key );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetVar_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    FairyGUI.UIPackage.SetVar( _key, _value );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_branch(RealStatePtr L)
        {
		    try {
            
			    LuaAPI.lua_pushstring(L, FairyGUI.UIPackage.branch);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_unloadBundleByFGUI(RealStatePtr L)
        {
		    try {
            
			    LuaAPI.lua_pushboolean(L, FairyGUI.UIPackage.unloadBundleByFGUI);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_branch(RealStatePtr L)
        {
		    try {
                
			    FairyGUI.UIPackage.branch = LuaAPI.lua_tostring(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_unloadBundleByFGUI(RealStatePtr L)
        {
		    try {
                
			    FairyGUI.UIPackage.unloadBundleByFGUI = LuaAPI.lua_toboolean(L, 1);
