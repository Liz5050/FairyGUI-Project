...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGComponentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 33, 17, 10);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetChildByPath", _m_GetChildByPath);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetChildByPath(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        FairyGUI.GObject gen_ret = gen_to_be_invoked.GetChildByPath( _path );
                        translator.Push(L, gen_ret);
