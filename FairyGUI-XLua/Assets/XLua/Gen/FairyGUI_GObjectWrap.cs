...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 37, 99, 49);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "asTree", _g_get_asTree);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "treeNode", _g_get_treeNode);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_asTree(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                FairyGUI.GObject gen_to_be_invoked = (FairyGUI.GObject)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.asTree);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_treeNode(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                FairyGUI.GObject gen_to_be_invoked = (FairyGUI.GObject)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.treeNode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
