...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp1(FairyGUI.EventContext p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp2(int p0, FairyGUI.GObject p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp3(int p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new FairyGUI.EventCallback1(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(FairyGUI.ListItemRenderer))
			{
			    return new FairyGUI.ListItemRenderer(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(FairyGUI.ListItemProvider))
			{
			    return new FairyGUI.ListItemProvider(__Gen_Delegate_Imp3);
			}
